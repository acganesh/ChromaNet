# Work in progress --
# Adapting TensorFlow code for multi-task sequence to sequence learning
import numpy as np
import tensorflow as tf

import data_utils

class MultitaskSeq2Seq():
    """
    ...
    # The seq2seq function: we use the one2many function
    def seq2seq_f(encoder_inputs, decoder_inputs, do_decode):
      return tf.nn.seq2seq.one2many_rnn_seq2seq(
          encoder_inputs,
          decoder_inputs,
          cell,
